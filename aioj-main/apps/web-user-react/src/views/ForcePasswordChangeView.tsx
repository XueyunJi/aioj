...
export function ForcePasswordChangeView() {
  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[var(--oj-app-bg)] px-4 py-8">
      <section className="w-full max-w-md rounded-2xl border border-[var(--oj-border)] bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold text-[var(--oj-primary)]">{t("common.appName")}</p>
