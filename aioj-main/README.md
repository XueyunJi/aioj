- 原项目作者：Mubai0628  & codex
- 当前推进迭代者：XueyunJi & 多种编程助手
- 迭代起始时间：2026年8月

### 当前状态  自原作者处fork到的项目存在部分细节缺陷，还需要一一测试核实并修复。
- 当前项目为沙箱和其他服务隔离在同一docker容器中的单机版，尚有安全风险。代码已备份并迁移至本仓库
- AI 出题模块问题已识别，修复方案已规划
- 测试用例上传问题已识别，存在16处缺陷，修复方案已规划
- 语义检索方向已经调研完毕，待下一步开发
- 项目持续迭代中
...
- [语义检索能力报告](docs/AI-OJ%20平台%20Embedding%20语义检索能力调研与部署报告.md)
- [测试用例上传问题报告](docs/测试用例大规模上传出现的问题以及解决方案.md)
# AIOJ
