    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtTokenService jwtTokenService,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        // SseEmitter completion and timeout use an async/error redispatch after the
                        // initial authenticated request has already been authorized. Keep that
                        // continuation from being rejected after the response is committed.
